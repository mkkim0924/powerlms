                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-4 col-6 d-flex align-items-center">
                                    <h2 class="card-title text-capitalize">@lang('backend.quiz_questions.header.edit')</h2>
                                </div>
                                <div class="col lg 4">
                                    <span
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        {!! Form::open([
                                            'route' => [request()->user_type . '.quiz.question_update', $question->id],
                                            'method' => 'POST',
                                            'enctype' => 'multipart/form-data',
                                            'files' => true,
                                            'id' => 'quizQueForm',
                                        ]) !!}
                                        @include('admin.quiz_questions.form', ['formMode' => 'edit'])
                                        {!! Form::close() !!}
                                    </div>
                                </div>
                            </div>
