                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-4 col-6 d-flex align-items-center">
                                <h2 class="card-title text-capitalize ">@lang('backend.manage_instructors.header.edit')</h2>
                            </div>
                            <div class="col lg 4">
                                <span class="pull-right d-inline-block float-right">
                                    <a href="{{ route('admin.instructors') }}" class="btn btn-rounded btn-outline-warning">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    @include('admin.user.instructor.form', ['formMode' => 'edit'])
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
