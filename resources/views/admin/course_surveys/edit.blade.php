                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-4 col-6 d-flex align-items-center">
                                    <h2 class="card-title text-capitalize">@lang('backend.course_survey.header.edit')</h2>
                                </div>
                                <div class="col lg 4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        {!! Form::open([
                                            'route'=>[request()->user_type.'.survey.update', $data->id],
                                            'method' => 'POST', 
                                            'enctype'=> "multipart/form-data", 
                                            'files' => true, 
                                            'id' => "" ]) !!}
                                        @include('admin.course_surveys.form', ['formMode' => 'edit'])
                                        {!! Form::close() !!}
                                    </div>
                                </div>
                            </div>
