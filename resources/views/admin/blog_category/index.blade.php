                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-4 col-6 d-flex align-items-center">
                                <h2 class="card-title text-capitalize">@lang('backend.blog_categories.header.list')</h2>
                            </div>
                            <div class="col lg 4">
                                <span
                                ...
                                <div class="card">
                                    <div class="table-responsive">
                                        <table id="zero_config" class="product-overview v-middle table">
                                            <thead>
                                                <tr>
                                                    <th>@lang('backend.blog_categories.label.title')</th>
                                                    <th>@lang('backend.blog_categories.label.actions')</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($category as $item)
                                                    <tr>
                                                        <td>{{ $item->name }}</td>
                                                        <td><a href="{{ route('admin.blog_category.edit', $item->id) }}"
                                                            ...
                                                            <a href="javascript:;"
                                                                onclick="confirmDelete('{{ route('admin.blog_category.delete', $item->id) }}')"
