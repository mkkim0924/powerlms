                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-4 col-6 d-flex align-items-center">
                                    <h2 class="card-title text-capitalize">@lang('backend.tests.header.create')</h2>
                                </div>
                                <div class="col lg 4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        {!! Form::open(['route'=>request()->user_type.'.quiz.store','method' => 'POST', 'enctype'=> "multipart/form-data", 'files' => true, 'id' => "quizForm"]) !!}
                                        @include('admin.quiz.form', ['formMode' => 'create'])
                                        {!! Form::close() !!}
                                    </div>
                                </div>
                            </div>
