                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4 col-6 d-flex align-items-center">
                            <h2 class="card-title text-capitalize">@lang('backend.course_interview_question.header.list')</h2>
                        </div>
                        <div class="col lg 4">
                            <span
                                class="pull-right d-inline-block @if (session('display_type') == 'rtl') float-left @else float-right @endif">
                                <a href="{{ route(request()->user_type . '.course_interview_question.create') }}"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            'route' => request()->user_type . '.course_interview_questions',
                            'id' => 'myForm',
                            ]) !!}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 align-self-end">
                                    ...
                                    <a href="{{ route(request()->user_type . '.course_interview_questions') }}"
                            ...
                            <div class="table-responsive">
                                <table id="datatable_without_search" class="product-overview v-middle table">
                                    <thead>
                                        <tr>
                                            <th>@lang('backend.course_interview_question.label.questions')</th>
                                            <th>@lang('backend.course_interview_question.label.course_name')</th>
                                            <th>@lang('backend.course_interview_question.label.action')</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route(request()->user_type . '.course_interview_question.edit', $item->id) }}"
                                                    data-toggle="tooltip"
                                                    data-original-title="@lang('global.button.edit')">
                                                    <i class="fas fa-pencil-alt text-inverse m-r-10"></i>
                                                </a>
                                                <a href="javascript:;"
                                                    onclick="confirmDelete('{{ route(request()->user_type . '.course_interview_question.delete', $item->id) }}')"
                                                    data-toggle="tooltip"
                                                    data-original-title="@lang('global.button.delete')">
