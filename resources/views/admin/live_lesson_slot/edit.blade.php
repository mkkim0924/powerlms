                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-4 col-6 d-flex align-items-center">
                                <h2 class="card-title text-capitalize">@lang('backend.live_lesson_slots.header.edit')</h2>
                            </div>
                            <div class="col lg 4">
                                <span
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form-horizontal" role="form" method="post"
                                    action="{{ route(request()->user_type . '.liveLessonSlots.update', $liveLessonSlot->id) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @include('admin.live_lesson_slot.form', ['formMode' => 'edit'])
                                </form>
                            </div>
                        </div>
                    </div>
