                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-4  col-6 d-flex align-items-center">
                                <h2 class="card-title text-capitalize">@lang('backend.banners.header.list')</h2>
                            </div>
                            <div class="col lg 4 ">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="zero_config" class="product-overview v-middle table">
                                <thead>
                                    <tr>
                                        <th>@lang('backend.banners.label.title')</th>
                                        <th>@lang('backend.banners.label.hero_title')</th>
                                        <th>@lang('backend.banners.label.action')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->hero_text }}</td>
                                        <td><a href="{{ route('admin.banner.edit', $item->id) }}"
